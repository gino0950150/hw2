...
t = np.arange(0,Ts * num_of_sample,Ts) # time vector; create Fs samples between 0 and 1.0 sec.
y = np.arange(0,Ts * num_of_sample,Ts) # signal vector; create Fs samples
